...
public:
    ...
    RE* simp() {
        ...
        // 5. `r1 + r2 ==> r1` falls L ( r1 ) = L ( r2 )        /* TODO */
        if ( r1->ofType() == ChType && r2->ofType() == ChType ) {
            if( equals(r1, r2) ) {
              return r1;
            }
        }
...
public:
    ...
    RE* simp() {
      ...
      if(r1->ofType() == EpsType) {
        return r2;
      } else if(r2->ofType() == EpsType) {
        return r1;
      }
      // 2. `r1 r2 => phi, falls r1={} oder r2={}`            /* TODO */
