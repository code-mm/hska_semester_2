...
public final class Bruch {
  ...
  /**
   * Setzt den Zähler.
   * @param zaehler Neuer Wert des Zählers
   */
  public Bruch setZaehler(int zaehler) {
    Bruch bruch = new Bruch(zaehler, this.nenner);
    return bruch;
  }

  /**
   * Setzt den Nenner.
   * @param nenner  Neuer Wert des Nenners
   */
  public Bruch setNenner(int nenner) {
    Bruch bruch = new Bruch(this.zaehler, nenner);
    return bruch;
  }
   ...
   * 
   * @param bruch1
   *          Erster zu subtrahierender Bruch
   * @param bruch2
   *          Zweiter zu subtrahierender Bruch
