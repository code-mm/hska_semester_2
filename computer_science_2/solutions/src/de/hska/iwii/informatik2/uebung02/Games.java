...
/**
 * Diese Klasse kapselt einige vordefinierte Startgenerationen fuer das Game of
 * Life.
 * 
...
public class Games {
  ...
  /**
   * Beschreibt eine Startgeneration mit ihrem Namen. Ohne eine Startgeneration
   * wird fuer den Namen eine Zufallsanordnung der lebenden und toten Zellen
   * erzeugt.
   */
  public static class Description {
    ...
    /**
     * Erzeugt eine Zufallsanordnung der lebenden und toten Zellen und gibt ihr
     * einen Namen.
     * 
     * @param name
     *          Name der Anordnung.
  ...
  public static final Description[] DESCRIPTIONS = new Description[] {
      new Description("Block", BLOCK), new Description("Behive", BEHIVE),
      new Description("Blinker 2", BLINKER2), new Description("Beacon 2", BEACON2),
      new Description("Small Gun", SMALL_GUN),
      new Description("Gosper Glider Gun", GOSPER_GLIDER_GUN), new Description("Zufall") };

  /**
   * Suche eine Generation anhand ihres Namens. Existiert keine Generation dieses
   * Namens, dann wird die Zufallsanordnung verwendet.
   * 
   * @param name
   *          Name der gesuchten Startgeneration.
