...
import de.hska.iwii.informatik2.uebung02.Games.Description;
...
public class GameOfLifeApplication extends Application {
  ...
  public static final Color BACKGROUND_COLOR =
      new Color(230.0 / 255.0, 230.0 / 255.0, 230.0 / 255.0, 1.0);

  /**
   * Standardfarbe einer Zelle.
   */
  public static final Color DEFAULT_CELL_COLOR =
      new Color(80.0 / 255.0, 80.0 / 255.0, 230.0 / 255.0, 1.0);
   ...
   * @param gameMenu
   *          Menue, zu dem der Eintrag hinzugefuegt werden soll.
   */
   ...
   * 
   * @param args
   *          Argumente, die dem Programm uebergeben wurden.
   */
